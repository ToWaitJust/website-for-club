    ...
    >
      ...
      >
        <button
          type="button"
          :disabled="submitting"
          class="btn-ghost tap-target w-full shrink-0 rounded-full border border-line bg-surface font-display font-medium text-ink disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
